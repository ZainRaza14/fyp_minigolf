                                            ...
                                            IVirtualButtonEventHandler
{
    ...
    private float mForce = 0.1f;
//	private float mMass = 0.0;
//	private float req_dist = 0.0;
    ...
    private void KickSoccerball()
    {
		...
		SoundManager.instance.PlaySingle (hitballSound);
		...
		//Distance_Calculate dist = new Distance_Calculate (mForce, mMass);

		//req_dist = dist.Calculate_Distance ();

		//Finding_points = new Finding_points (req_dist);

		//points = Finding_points.Points();
		...
		Vector3 kickDir = new Vector3(20, 0, 0).normalized;
        ...
        mIsRolling = true;
        mTimeRolling = 0.0f;
    } // Moisture , dirt , different forces , different speeds, different distances, varoety of fields, levels
